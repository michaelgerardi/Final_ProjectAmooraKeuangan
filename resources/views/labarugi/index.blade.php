                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables">
                                    ...
                                    <div class="card">
                                        ...
                                        <br><br><br>   
                                        <h5 class="text-left font-weight-bolder">Pemasukkan</h5>   
                                        <br> 
                                        ...
                                        @endforeach 
                                        <br><br>
                                         <h5 class="text-left font-weight-bolder">Pengeluaran</h5>   
                                        <br>
                                        ...
                                        <hr>
                                         <div class="row row-cols-2 row-cols-sm-2 row-cols-md-2">
                                            ...
                                            <div class="col"><h5 class="text-center font-weight-bold col">@currency($keluartot)</h5> </div>
                                        </div> 
                                        <br>
                                         <div class="row row-cols-2 row-cols-sm-2 row-cols-md-2">
