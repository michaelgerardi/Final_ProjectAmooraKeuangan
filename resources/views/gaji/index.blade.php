                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Penggajian</h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data Table Pengajian</h4>
                      ...
                      <div class="modal-body">
                              <form action="/penggajian/tambah" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPegawai">Nama Sewer</label>
                                    <select name="id_sewer" id="exampleInputPegawai">
                                      @foreach ($data_sewer as $data_sewer)
                                        <option value={{$data_sewer->id_sewer}}>{{$data_sewer->nama}}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Gaji Sewer</label>
                                  <input name="gaji"type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Gaji Sewer">
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input name="tgl_gaji"type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                 </div>
                            </div>
