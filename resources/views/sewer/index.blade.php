                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Sewer</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Sewer</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data Table Sewer</h4>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <div class="modal-body">
                              <form action="/sewer/tambah" method="POST" enctype='multipart/form-data'>
                                ...
                                <div class="form-group">
                                  <label for="exampleInputEmail1">NIP Karyawan</label>
                                  <input name="nip"type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="NIP Karyawan">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Nama Karyawan</label>
