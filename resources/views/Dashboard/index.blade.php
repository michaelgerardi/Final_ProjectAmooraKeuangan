                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Michael Gerard <i class="fa fa-angle-down"></i></h4>
                            ...
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="d-flex justify-content-between pb-2">
                                        <h2>@currency($total_pemasukan->pemasukan)</h2>
                                        {{-- <span>- 45.87</span> --}}
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="d-flex justify-content-between pb-2">
                                        <h2>@currency($total_pengeluaran->pengeluaran)</h2>
                                        {{-- <span>- 45.87</span> --}}
                                    </div>
                                </div>
