    ...
    <div class="page-container">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Buku Besar</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Buku Besar</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables">
                                    ...
                                    <table  class="w3-table-all w3-card-4" style="color: black">       
                                            ...
                                            @foreach($kas as $kas)
                                            @php 
                                            $Saldokas=$Saldokas+$kas['debit']-$kas['kredit'];
                                            @endphp
                                                <tr>
                                                    <td> {{$kas['tgl']}} </td>
                                                    <td> {{$kas['ket']}} </td>
                ...
                @foreach ($pemasukan as $masuk)
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">{{$masuk->ket}}</h4>
                                <div class="data-tables">
                                    {{-- <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal"><a style="color:white;text-decoration: none;" href="{{route('jurnal_umum')}}">
                                      Buat Jurnal Umum
                                    </button> --}}
                                    ...
                                    <table  class="w3-table-all w3-card-4" style="color: black">       
                                            ...
                                            @php 
                                            $Saldopemasukan=$Saldopemasukan+$pemasukans['debit']-$pemasukans['kredit'];
                                            @endphp
                                                <tr>
                                                    <td> {{$pemasukans['tgl']}} </td>
                                                    <td> {{$pemasukans['ket']}} </td>
                                                    <td> - </td>
                                                    <td> @currency($pemasukans['debit']) </td>
                                                    <td> @currency($pemasukans['kredit']) </td>
                                                    <td> @currency($Saldopemasukan) </td>
                                                </tr>
                                            @endforeach  
                                    </table>
                                </div>
                ...
                @foreach ($pengeluaran as $keluar)
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">{{$keluar->ket}}</h4>
                                <div class="data-tables">
                                    {{-- <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal"><a style="color:white;text-decoration: none;" href="{{route('jurnal_umum')}}">
                                      Buat Jurnal Umum
                                    </button> --}}
                                    ...
                                    <table  class="w3-table-all w3-card-4" style="color: black">       
                                            ...
                                            @php 
                                            $Saldopengeluaran=$Saldopengeluaran+$pengeluaran['debit']-$pengeluaran['kredit'];
                                            @endphp
                                                <tr>
                                                    <td> {{$pengeluaran['tgl']}} </td>
                                                    <td> {{$pengeluaran['ket']}} </td>
                                                    <td> - </td>
                                                    <td> @currency($pengeluaran->debit) </td>
                                                    <td> @currency($pengeluaran->kredit) </td>
                                                    <td> @currency($Saldopengeluaran) </td>
                                                </tr>
                                            @endforeach  
                                    </table>
                                </div>
                ...
                @endforeach
                    ...
                    {{-- <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Data Pemasukkan</h5>
                      ...
                      <div class="modal-body">
                              <form action="/pemasukkan/tambah" method="POST">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="tanggal" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Gaji Sewer">
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Keterangan Pemasukan</label>
                                    <textarea name="ket_pemasukkan"class="form-control" id="exampleFormControlTextarea1" rows="3" ></textarea>
                                 </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Nominal Pemasukan</label>
                                    <input name="nominal" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nominal">
                                  </div>
                            </div>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2022 | Amoora Couture</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
